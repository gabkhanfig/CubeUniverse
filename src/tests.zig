comptime {
    _ = @import("shared/world/world_transform.zig");
    _ = @import("shared/world/chunk/Chunk.zig");
    _ = @import("shared/world/chunk/Inner.zig");
    _ = @import("shared/world/n_tree/NTree.zig");
