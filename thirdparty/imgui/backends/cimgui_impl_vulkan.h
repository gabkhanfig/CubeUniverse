...
// Called by user code
CIMGUI_API bool cImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo* info, VkRenderPass render_pass);
CIMGUI_API void cImGui_ImplVulkan_Shutdown(void);
CIMGUI_API void cImGui_ImplVulkan_NewFrame(void);
CIMGUI_API void cImGui_ImplVulkan_RenderDrawData(ImDrawData* draw_data, VkCommandBuffer command_buffer);  // Implied pipeline = VK_NULL_HANDLE
CIMGUI_API void cImGui_ImplVulkan_RenderDrawDataEx(ImDrawData* draw_data, VkCommandBuffer command_buffer, VkPipeline pipeline /* = VK_NULL_HANDLE */);
CIMGUI_API bool cImGui_ImplVulkan_CreateFontsTexture(void);
CIMGUI_API void cImGui_ImplVulkan_DestroyFontsTexture(void);
...
CIMGUI_API bool cImGui_ImplVulkan_LoadFunctions(PFN_vkVoidFunction (*loader_func)(const char* function_name, void* user_data));                                     // Implied user_data = nullptr
CIMGUI_API bool cImGui_ImplVulkan_LoadFunctionsEx(PFN_vkVoidFunction (*loader_func)(const char* function_name, void* user_data), void* user_data /* = nullptr */);
...
// Helpers
CIMGUI_API void               cImGui_ImplVulkanH_CreateOrResizeWindow(VkInstance instance, VkPhysicalDevice physical_device, VkDevice device, ImGui_ImplVulkanH_Window* wnd, uint32_t queue_family, const VkAllocationCallbacks* allocator, int w, int h, uint32_t min_image_count);
CIMGUI_API void               cImGui_ImplVulkanH_DestroyWindow(VkInstance instance, VkDevice device, ImGui_ImplVulkanH_Window* wnd, const VkAllocationCallbacks* allocator);
